...
const Profile = ({pic,user,name,bio,diff,cat,plat,played,similar}) => {
    ...
    const onChangePlat = (currentNode,selectedNodes) => {
        if(tempPlat.find(x => x.label === currentNode.label)!==undefined){
            tempPlat.find(x => x.label === currentNode.label).checked = !tempPlat.find(x => x.label === currentNode.label).checked;
            return;
        }
        if(tempPlat.find(x => x.label === "Microsoft").children.find(x => x.label === currentNode.label)!==undefined){
            tempPlat.find(x => x.label === "Microsoft").children.find(x => x.label === currentNode.label).checked = !tempPlat.find(x => x.label === "Microsoft").children.find(x => x.label === currentNode.label).checked;
            return;
        }
        if(tempPlat.find(x => x.label === "Nintendo").children.find(x => x.label === currentNode.label)!==undefined){
            tempPlat.find(x => x.label === "Nintendo").children.find(x => x.label === currentNode.label).checked = !tempPlat.find(x => x.label === "Nintendo").children.find(x => x.label === currentNode.label).checked;
            return;
        }
        if(tempPlat.find(x => x.label === "Sony").children.find(x => x.label === currentNode.label)!==undefined){
            tempPlat.find(x => x.label === "Sony").children.find(x => x.label === currentNode.label).checked = !tempPlat.find(x => x.label === "Sony").children.find(x => x.label === currentNode.label).checked;
            return;
        }
        if(tempPlat.find(x => x.label === "Other").children.find(x => x.label === currentNode.label)!==undefined){
            tempPlat.find(x => x.label === "Other").children.find(x => x.label === currentNode.label).checked = !tempPlat.find(x => x.label === "Other").children.find(x => x.label === currentNode.label).checked;
            return;
        }
    }
